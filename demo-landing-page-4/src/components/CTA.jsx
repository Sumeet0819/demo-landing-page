...
const CTA = () => {
  ...
  return (
    <section ref={containerRef} className="w-full h-[60vh] md:h-[70vh] relative overflow-hidden flex items-center justify-center mt-12 px-6">
      <img 
        ref={imgRef}
        src="https://plus.unsplash.com/premium_photo-1674019234994-eceabbdd091d?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
        alt="Join Revolution" 
